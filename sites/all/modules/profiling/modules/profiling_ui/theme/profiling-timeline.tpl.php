...
<div class="profiling-timeline">
  ...
  <div class="profiling-timeline-line"">
    ...
    <div class="profiling-timeline-container" style="position: relative;">
      <div class="profiling-timeline-slice" title="<?php print $slice['title']; ?>" style="position: absolute; left:<?php print $left; ?>; top: 0; width: <?php print $width; ?>; height: <?php print $height; ?>;">
