<?php
file_put_contents('/tmp/webhook.txt',date('F j, Y, g:i a', $_SERVER['REQUEST_TIME'])."\n".print_r($_POST,true), FILE_APPEND);
...
if (isset($event_location_map[$_POST['HandshakeKey']])) {
  ...
  $req_url = 'http://www.yogaaid.com/RemoteSignup.axd';
  ...
  file_put_contents($varname, $response);
}
