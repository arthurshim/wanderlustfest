  ...
  if ($settings['view_enabled'][$view->name] == 1 && $show) {
    ...
    foreach ($view->display as $display_name => $display_data) {
      if (!$selected_displays || !count($selected_displays) || in_array($display_name, $selected_displays)) {
       ...
       // drupal_set_message('<pre>' . print_r($subdomain, 1) . '</pre>');
      if($subdomain == 'oahu' && $display_data->display_title == 'Healing') {
         $display_data->display_title = 'Surf & Paddle';
      }  else {
	  switch($display_data->display_title) {
	   ...
	   if($subdomain == 'oahu' && $display_data->display_title == 'Theater' ) {
	    $display_data->display_title = 'Movement'; 
      	   ...
      	   if(($subdomain == 'brooklyn'  || $subdomain == 'atlanta' ) && $display_data->display_title == 'Speakeasy' ) {
	    $display_data->display_title = 'Speakers'; 
	   }
    ...
    // drupal_set_message('<pre>' . print_r($displays, 1) . '</pre>');
     ...
     $domains = array('chicago', 'sf', 'la', 'philadelphia'); 
     
     if(in_array($subdomain, $domains) && arg(0) == 'lineup') {
      unset($displays[0][0]);  
      unset($displays[0][3]);
      unset($displays[0][4]);
      unset($displays[0][5]);
      ...
      unset($displays[0][7]);
       ...
       if($subdomain == 'brooklyn'  && arg(0)  == 'lineup') {
      //unset($displays[0][0]);
     // unset($displays[0][3]);
      unset($displays[0][5]);
      unset($displays[0][6]);
      unset($displays[0][7]);
	    ...
	    if($subdomain == 'atlanta'  && arg(0)  == 'lineup') {
      //unset($displays[0][0]);
     // unset($displays[0][3]);
      unset($displays[0][5]);
      unset($displays[0][6]);
