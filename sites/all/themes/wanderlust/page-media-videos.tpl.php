...
<body class="body-content-photos <?php print $body_classes; ?>">
  ...
  <div id="container" class="clearfix">
    ...
    <header id="header" role="banner" class="clearfix">
      ...
      <div class="tomap">
        <a href="<?php   $base = wl_get_base_domain(); print "http://{$base}"; ?>" title="<?php print t('To map'); ?>"><img src="http://9394bc4f934eb8c957d8-2f084e1f525b6270d41d6d2c79f4c609.r93.cf1.rackcdn.com/2013-images/see-all-events.png" alt="<?php print t('To map'); ?>" /></a>
      </div>
