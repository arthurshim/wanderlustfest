...
if( isMobile.any() ) {
 $('head').append('<script type="text/javascript" src="/sites/all/modules/wl_helper/wl_helper_mobile.js"></script>');

} 

else {
 $('head').append('<script type="text/javascript" src="/sites/all/modules/wl_helper/wl_helper.js"></script>');
