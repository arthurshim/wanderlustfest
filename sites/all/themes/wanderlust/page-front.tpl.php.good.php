  ...
  <div id="about">
    ...
    <div class="dialog">
        <div class="content">
		  ...
		  <div id="aboutFancy">View The Wanderlust Video</a></div>   
          <div class="arrow"></div>
        </div>
    </div>
...
<!--begin mobile-->
  ...
  <?php
     if ($class == 'festival') {
        ...
        $fests1 .= '<li>' . $item . '<div id="site-checkbox"><input type="checkbox" value="0" name="' . $site->purl_prefix . '"' . $c . 'onClick="SetCookie(\'mysite\', ' . $site->purl_prefix . ', 30);"><div id="saveDefualt">Save as my default</div></div></li>';
        ...
        $yogas1 .= '<li>' . $item . '<div id="site-checkbox"><input type="checkbox" value="0" name="' . $site->purl_prefix . '"' . $c . 'onClick="SetCookie(\'mysite\', ' . $site->purl_prefix . ', 30);">Save as my default</div></div></li>';
...
<div class="splash-mobile">
  <div class="header">
    <h1><img src="images/splash-mobile-logo.gif"></h1>
  </div>
...
$('#removeMobileLink a').remove();
	...
	else if (isMobile.Android() || isMobile.BlackBerry() || isMobile.iOS() || isMobile.Opera() || isMobile.Windows()) {
    //$("head").prepend('<meta name="viewport" content="width=device-width, initial-scale=.4, maximum-scale=1">');
    $("head").append('<link rel="stylesheet" type="text/css" href="sites/all/themes/wanderlust/css/mobile-stylesheet-handset.css" />');
