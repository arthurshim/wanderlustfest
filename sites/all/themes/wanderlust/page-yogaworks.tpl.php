      ...
      <div id="main-content" class="region clear-block body-11">
       <?php if ($title): ?>
        ...
        <div class="tabs"><?php print $tabs; ?></div>
         ...
         <?php print $content; ?>
 		<p class="legal">
			No purchase necessary to enter contest. US residents only. One entry per person. Entries must be received by 6/28/10. Winner notified by email prior to 7/5/10. (1) Grand prize consisting of 2 "Seeker" tickets to Wanderlust. Approximate retail value: $750. Online entries only. Odds estimated at 1:1000. Wanderlust Festival is held at Squaw Valley USA in Olympic Valley, CA. If festival is delayed, postponed or cancelled for any reason, winner will not be reimbursed for tickets, but tickets are subject to standard rain check policies and procedures established by issuer. Coupons are not redeemable or exchangeable for cash and are subject to all terms and conditions of use as established by issuer. Prizes consist of only the items specifically listed as the prize. Sponsor reserves the right to substitute a prize of equal or greater value. Contest authorized by Wanderlust Festival LLC, 26 Dobbin St., 3rd Floor, New York, NY 11222. Questions? Email info@wanderlustfestival.com.
 		</p>
		</div>
      </div>
