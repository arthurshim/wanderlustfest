...
<!-- WL Global Top Bar -->
  ...
  <div id="container" class="clearfix">
   ...
   <div class="tomap">
      <a href="http://wanderlust.com/yoga-festivals" target="_blank" title="<?php print t('To map'); ?>"><img src="<?php print  base_path() . path_to_theme() . '/images/newmap_icon.png'//print $logo; ?>" alt="<?php print t('To map'); ?>" /></a>
   </div>
